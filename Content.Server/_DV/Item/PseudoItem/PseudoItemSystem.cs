...
{
    [Dependency] private readonly StorageSystem _storage = default!; // starcup
    [Dependency] private readonly ItemSystem _item = default!; // starcup
    [Dependency] private readonly DoAfterSystem _doAfter = default!; // starcup
